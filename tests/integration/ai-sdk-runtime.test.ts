...
const runtimeDescribe = hasRealAiSdkDeps ? describe : describe.skip;
...
describe("AI SDK dd-trace integration", () => {
  ...
  runtimeDescribe("runtime with dd-trace", () => {
  ...
  runtimeDescribe("dd-trace span capture", () => {
